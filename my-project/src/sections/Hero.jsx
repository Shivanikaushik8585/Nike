...
function Hero() {
  ...
  return (
    ...
    <section id="home" className='w-full  flex xl:flex-row
     flex-col justify-center min-h-screen gap-10 max-container  border-2  p-2'>
      <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full max-x1:padding-x pt-28'>
        ...
        <h1 className=' mt-10 font-palanquin text-8xl  max-sm:text-[72px] max-sm:leading-[82] font-bold'>
          <span className=' x1:whitespace-nowrap relative z-10 pr-10' >New Arrivals
          </span>
          <br />
        ...
        <Button label="Shop now"
          iconURL={arrowRight}
        />
        <div className='flex justify-content-start items-start flex-wrap w-full mt-20 gap-16'>
          {statistics.map((stat) => (
            <div>
    ...
    <div className='relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-center'>
      <img  className="object-contain relative  z-10 "src={bigShoeImg} width={610} height={500} alt="bigshoes1" />
